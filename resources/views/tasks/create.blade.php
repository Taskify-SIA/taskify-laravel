...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
    <div>
        <h2 class="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Buat Tugas Baru</h2>
        <p class="text-gray-500 dark:text-dark-muted mt-1">Tambahkan tugas baru untuk meningkatkan produktivitas Anda.</p>
    </div>
