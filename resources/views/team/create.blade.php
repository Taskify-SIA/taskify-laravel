...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
    <div>
        <h2 class="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Tambah Anggota Tim</h2>
        <p class="text-gray-500 dark:text-dark-muted mt-1">Undang anggota baru ke tim Anda.</p>
    </div>
            ...
            <div class="mb-6 text-center">
                ...
                <div class="flex justify-center mb-4">
                    <div class="relative">
                        <img 
                            id="avatar-preview" 
                            src="https://ui-avatars.com/api/?name=New+Member&background=4900c7&color=fff" 
